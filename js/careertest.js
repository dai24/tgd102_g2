    ...
    methods: {
        wholeanswer(i,k){
            ...
            if( this.mbti === "ISTJ"){
                ...
                this.mbtianswer.job = "藝術工作者、時尚設計師"
                ...
                this.mbtianswer.job = "文案寫手、平面設計師"
                ...
                this.mbtianswer.job = "商業分析師、軟體設計師"
